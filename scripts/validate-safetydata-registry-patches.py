...
try:
    ...
    raise SystemExit("missing dependency: install jsonschema before validating Safety Data registry patches") from exc


EXPECTED_SCHEMA_VERSION = "datapan.safetydata-registry-patches.v1"
DEFAULT_SCHEMA = pathlib.Path("schemas/datapan.safetydata-registry-patches.v1.schema.json")
