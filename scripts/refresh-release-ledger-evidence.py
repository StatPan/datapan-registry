...
WRITE_COMMANDS: tuple[Command, ...] = (
    ...
    Command(("python3", "scripts/generate-readme-runtime-snapshot.py")),
    Command(("python3", "scripts/generate-source-report-inventory.py")),
    Command(("python3", "scripts/generate-source-runtime-evidence-rollup.py")),
    ...
    Command(("python3", "scripts/generate-release-ledger-goal-completion-audit.py")),
...
CHECK_COMMANDS: tuple[Command, ...] = (
    ...
    Command(("python3", "scripts/generate-sustainable-coverage.py", "--check")),
    Command(("python3", "scripts/generate-readme-runtime-snapshot.py", "--check")),
    Command(("python3", "scripts/generate-source-runtime-evidence-rollup.py", "--check")),
    Command(("python3", "scripts/validate-source-runtime-evidence-rollup.py")),
    ...
    Command(("python3", "scripts/promote-credential-runtime-session-review.py", "--self-test")),
    Command(("python3", "scripts/promote-credential-runtime-session-review.py", "--check")),
    Command(("python3", "scripts/validate-credential-runtime-manual-review-decision.py")),
    Command(("python3", "scripts/generate-credential-runtime-manual-review-technical-rebinding.py", "--check")),
    ...
    Command(("python3", "scripts/generate-release-ledger-goal-completion-audit.py", "--check")),
