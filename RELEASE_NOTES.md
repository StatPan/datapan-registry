...
- generated_at: `2026-07-03T20:23:35Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3354` changed, `8706` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `90` adapters, `106` hosts
- split_readiness: `ready`
- verification_capable_adapters: `90`
- call_capable_adapters: `23`
- dependency_operations: `19147` total, `11419` gateway, `7537` external, `7527` registered-adapter, `29` missing-adapter
...
- provider_backlog: `258` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `19005` callable operations (`99.3%`), external adapter coverage `99.6%`, verification evidence coverage `13.9%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `13.9%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `2655` total, `1217` verified, `223` failed, `1215` skipped, `0` unknown
