...
- generated_at: `2026-06-30T07:49:18Z`
- provider: `data.go.kr`
...
- coverage: `12063` callable operations (`98.8%`), external adapter coverage `95.4%`, verification evidence coverage `5.7%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `1` batches, `10` planned operations, `11309` gateway gaps, `0` adapter gaps
- verification_plan_artifact: `reports/verification-plan.json`
- runtime_evidence_growth: `5.7%` coverage, target `10.0%`, remaining `525`, status `below_target`
...
- verification: `696` total, `22` verified, `87` failed, `587` skipped, `0` unknown
