...
- generated_at: `2026-07-03T14:40:13Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `41` changed, `12019` stable
...
- dependency_operations: `15404` total, `11419` gateway, `3794` external, `3784` registered-adapter, `29` missing-adapter
...
- coverage: `15262` callable operations (`99.1%`), external adapter coverage `99.2%`, verification evidence coverage `10.0%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `15` batches, `105` planned operations, `10744` gateway gaps, `2918` adapter gaps
...
- verification: `1541` total, `265` verified, `113` failed, `1163` skipped, `0` unknown
