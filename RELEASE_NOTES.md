...
- generated_at: `2026-06-25T02:50:14Z`
- provider: `data.go.kr`
...
- provider_adapters: `19` adapters, `23` hosts
- split_readiness: `ready`
- verification_capable_adapters: `19`
- call_capable_adapters: `14`
- dependency_operations: `12205` total, `11419` gateway, `594` external, `560` registered-adapter, `53` missing-adapter
- adapter_backlog: `17` target hosts, `53` target operations
- provider_backlog: `179` hosts, `17` missing-adapter hosts, `53` operations needing adapters
- coverage: `12063` callable operations (`98.8%`), external adapter coverage `91.4%`, verification evidence coverage `1.9%`
...
- `3`. `ws.bus.go.kr`: `5` operations across `1` specs
- `4`. `data.jeju.go.kr`: `4` operations across `2` specs
- `5`. `www.rda.go.kr`: `4` operations across `2` specs

## Verification Evidence

- verification: `233` total, `21` verified, `74` failed, `138` skipped, `0` unknown
