...
- generated_at: `2026-07-04T01:42:18Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4023` changed, `8037` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `113` adapters, `139` hosts
- split_readiness: `ready`
- verification_capable_adapters: `113`
- call_capable_adapters: `23`
- dependency_operations: `20507` total, `11419` gateway, `8897` external, `8887` registered-adapter, `29` missing-adapter
...
- provider_backlog: `290` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20365` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `19.7%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `19.7%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `4037` total, `2188` verified, `306` failed, `1543` skipped, `0` unknown
