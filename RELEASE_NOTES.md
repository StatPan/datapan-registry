...
- generated_at: `2026-07-03T18:42:11Z`
- provider: `data.go.kr`
...
- dependency_operations: `18457` total, `11419` gateway, `6847` external, `6837` registered-adapter, `29` missing-adapter
...
- coverage: `18315` callable operations (`99.2%`), external adapter coverage `99.6%`, verification evidence coverage `10.6%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `20` batches, `129` planned operations, `10714` gateway gaps, `3703` adapter gaps
- verification_plan_artifact: `reports/verification-plan.json`
- runtime_evidence_growth: `10.6%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `1950` total, `606` verified, `147` failed, `1197` skipped, `0` unknown
