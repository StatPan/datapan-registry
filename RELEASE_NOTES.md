...
- generated_at: `2026-07-02T21:37:18Z`
- provider: `data.go.kr`
...
- dependency_operations: `12495` total, `11419` gateway, `885` external, `875` registered-adapter, `29` missing-adapter
...
- coverage: `12353` callable operations (`98.9%`), external adapter coverage `96.8%`, verification evidence coverage `10.2%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `7` batches, `64` planned operations, `10774` gateway gaps, `242` adapter gaps
