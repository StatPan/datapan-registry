...
- generated_at: `2026-07-04T00:05:46Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3862` changed, `8198` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `108` adapters, `128` hosts
- split_readiness: `ready`
- verification_capable_adapters: `108`
- call_capable_adapters: `23`
- dependency_operations: `20140` total, `11419` gateway, `8530` external, `8520` registered-adapter, `29` missing-adapter
...
- provider_backlog: `278` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `19998` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `18.1%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `18.1%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3654` total, `1809` verified, `306` failed, `1539` skipped, `0` unknown
