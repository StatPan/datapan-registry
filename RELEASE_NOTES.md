...
- generated_at: `2026-07-04T01:55:17Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4050` changed, `8010` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `114` adapters, `141` hosts
- split_readiness: `ready`
- verification_capable_adapters: `114`
- call_capable_adapters: `23`
- dependency_operations: `20583` total, `11419` gateway, `8973` external, `8963` registered-adapter, `29` missing-adapter
...
- provider_backlog: `292` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20441` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `20.0%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `20` batches, `114` planned operations, `10714` gateway gaps, `3380` adapter gaps
- verification_plan_artifact: `reports/verification-plan.json`
- runtime_evidence_growth: `20.0%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `4113` total, `2264` verified, `306` failed, `1543` skipped, `0` unknown
