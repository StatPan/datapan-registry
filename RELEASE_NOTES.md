...
- generated_at: `2026-07-03T14:55:27Z`
- provider: `data.go.kr`
...
- provider_adapters: `63` adapters, `70` hosts
- split_readiness: `ready`
- verification_capable_adapters: `63`
- call_capable_adapters: `23`
- dependency_operations: `15664` total, `11419` gateway, `4054` external, `4044` registered-adapter, `29` missing-adapter
...
- provider_backlog: `221` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `15522` callable operations (`99.1%`), external adapter coverage `99.3%`, verification evidence coverage `10.0%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `15` batches, `120` planned operations, `10744` gateway gaps, `3152` adapter gaps
...
- verification: `1567` total, `290` verified, `114` failed, `1163` skipped, `0` unknown
