...
- generated_at: `2026-07-03T20:42:11Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3437` changed, `8623` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `91` adapters, `107` hosts
- split_readiness: `ready`
- verification_capable_adapters: `91`
- call_capable_adapters: `23`
- dependency_operations: `19392` total, `11419` gateway, `7782` external, `7772` registered-adapter, `29` missing-adapter
...
- provider_backlog: `259` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `19250` callable operations (`99.3%`), external adapter coverage `99.6%`, verification evidence coverage `15.0%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `15.0%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `2900` total, `1217` verified, `223` failed, `1460` skipped, `0` unknown
