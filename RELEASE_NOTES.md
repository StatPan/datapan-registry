...
- generated_at: `2026-07-04T06:33:35Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4400` changed, `7660` stable
...
- dependency_operations: `21254` total, `11419` gateway, `9644` external, `9634` registered-adapter, `29` missing-adapter
...
- coverage: `21112` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `22.4%`, evidence-adjusted adapter candidates `0`
...
- verification: `4771` total, `2839` verified, `389` failed, `1543` skipped, `0` unknown
