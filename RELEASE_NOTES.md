...
- generated_at: `2026-07-04T02:17:16Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4077` changed, `7983` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `117` adapters, `144` hosts
- split_readiness: `ready`
- verification_capable_adapters: `117`
- call_capable_adapters: `23`
- dependency_operations: `20625` total, `11419` gateway, `9015` external, `9005` registered-adapter, `29` missing-adapter
...
- provider_backlog: `295` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20483` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `20.1%`, evidence-adjusted adapter candidates `0`
...
- verification: `4142` total, `2267` verified, `332` failed, `1543` skipped, `0` unknown
