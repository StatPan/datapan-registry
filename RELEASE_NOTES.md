...
- generated_at: `2026-07-03T21:32:33Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3599` changed, `8461` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `96` adapters, `115` hosts
- split_readiness: `ready`
- verification_capable_adapters: `96`
- call_capable_adapters: `23`
- dependency_operations: `19679` total, `11419` gateway, `8069` external, `8059` registered-adapter, `29` missing-adapter
...
- provider_backlog: `266` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `19537` callable operations (`99.3%`), external adapter coverage `99.6%`, verification evidence coverage `16.2%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `20` batches, `122` planned operations, `10714` gateway gaps, `3390` adapter gaps
- verification_plan_artifact: `reports/verification-plan.json`
- runtime_evidence_growth: `16.2%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3191` total, `1443` verified, `282` failed, `1466` skipped, `0` unknown
