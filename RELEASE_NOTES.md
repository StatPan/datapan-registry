...
- generated_at: `2026-07-04T00:18:47Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3885` changed, `8175` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `109` adapters, `129` hosts
- split_readiness: `ready`
- verification_capable_adapters: `109`
- call_capable_adapters: `23`
- dependency_operations: `20163` total, `11419` gateway, `8553` external, `8543` registered-adapter, `29` missing-adapter
...
- provider_backlog: `279` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20021` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `18.2%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `18.2%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3677` total, `1832` verified, `306` failed, `1539` skipped, `0` unknown
