...
- generated_at: `2026-07-04T03:51:01Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4234` changed, `7826` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `123` adapters, `155` hosts
- split_readiness: `ready`
- verification_capable_adapters: `123`
- call_capable_adapters: `23`
- dependency_operations: `20930` total, `11419` gateway, `9320` external, `9310` registered-adapter, `29` missing-adapter
...
- provider_backlog: `308` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20788` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `21.2%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `21.2%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `4447` total, `2572` verified, `332` failed, `1543` skipped, `0` unknown
