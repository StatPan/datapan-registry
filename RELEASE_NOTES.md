...
- generated_at: `2026-07-04T02:07:18Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4076` changed, `7984` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `116` adapters, `143` hosts
- split_readiness: `ready`
- verification_capable_adapters: `116`
- call_capable_adapters: `23`
- dependency_operations: `20624` total, `11419` gateway, `9014` external, `9004` registered-adapter, `29` missing-adapter
...
- provider_backlog: `294` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20482` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `20.1%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `20.1%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `4141` total, `2266` verified, `332` failed, `1543` skipped, `0` unknown
