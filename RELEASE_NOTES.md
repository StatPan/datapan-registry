...
- generated_at: `2026-07-03T23:38:57Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3823` changed, `8237` stable
...
- dependency_operations: `20041` total, `11419` gateway, `8431` external, `8421` registered-adapter, `29` missing-adapter
...
- coverage: `19899` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `17.6%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `17.6%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3527` total, `1735` verified, `306` failed, `1486` skipped, `0` unknown
