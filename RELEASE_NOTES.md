...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3786` changed, `8274` stable
...
- dependency_operations: `19996` total, `11419` gateway, `8386` external, `8376` registered-adapter, `29` missing-adapter
...
- coverage: `19854` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `17.4%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `17.4%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3477` total, `1685` verified, `306` failed, `1486` skipped, `0` unknown
