...
- generated_at: `2026-07-04T05:31:11Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4351` changed, `7709` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `133` adapters, `166` hosts
- split_readiness: `ready`
- verification_capable_adapters: `133`
- call_capable_adapters: `23`
- dependency_operations: `21182` total, `11419` gateway, `9572` external, `9562` registered-adapter, `29` missing-adapter
...
- provider_backlog: `318` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `21040` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `22.2%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `22.2%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `4699` total, `2789` verified, `367` failed, `1543` skipped, `0` unknown
