...
- generated_at: `2026-07-04T04:09:05Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4250` changed, `7810` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `125` adapters, `158` hosts
- split_readiness: `ready`
- verification_capable_adapters: `125`
- call_capable_adapters: `23`
- dependency_operations: `20950` total, `11419` gateway, `9340` external, `9330` registered-adapter, `29` missing-adapter
...
- provider_backlog: `311` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20808` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `21.3%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `21.3%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `4467` total, `2590` verified, `334` failed, `1543` skipped, `0` unknown
