...
- generated_at: `2026-07-04T04:00:35Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `4247` changed, `7813` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `124` adapters, `157` hosts
- split_readiness: `ready`
- verification_capable_adapters: `124`
- call_capable_adapters: `23`
- dependency_operations: `20947` total, `11419` gateway, `9337` external, `9327` registered-adapter, `29` missing-adapter
...
- provider_backlog: `310` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `20805` callable operations (`99.3%`), external adapter coverage `99.7%`, verification evidence coverage `21.3%`, evidence-adjusted adapter candidates `0`
...
- verification: `4464` total, `2587` verified, `334` failed, `1543` skipped, `0` unknown
