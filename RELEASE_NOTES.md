...
- generated_at: `2026-07-03T21:17:58Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3533` changed, `8527` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `96` adapters, `114` hosts
- split_readiness: `ready`
- verification_capable_adapters: `96`
- call_capable_adapters: `23`
- dependency_operations: `19595` total, `11419` gateway, `7985` external, `7975` registered-adapter, `29` missing-adapter
...
- provider_backlog: `265` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `19453` callable operations (`99.3%`), external adapter coverage `99.6%`, verification evidence coverage `15.8%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `15.8%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3100` total, `1352` verified, `282` failed, `1466` skipped, `0` unknown
