...
- generated_at: `2026-07-03T17:14:37Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `98` changed, `11962` stable
...
- dependency_operations: `17058` total, `11419` gateway, `5448` external, `5438` registered-adapter, `29` missing-adapter
...
- coverage: `16916` callable operations (`99.2%`), external adapter coverage `99.5%`, verification evidence coverage `10.4%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `20` batches, `150` planned operations, `10714` gateway gaps, `3894` adapter gaps
...
- verification: `1774` total, `436` verified, `145` failed, `1193` skipped, `0` unknown
