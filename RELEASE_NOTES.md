...
- generated_at: `2026-07-03T17:43:13Z`
- provider: `data.go.kr`
...
- provider_adapters: `76` adapters, `86` hosts
- split_readiness: `ready`
- verification_capable_adapters: `76`
- call_capable_adapters: `23`
- dependency_operations: `17637` total, `11419` gateway, `6027` external, `6017` registered-adapter, `29` missing-adapter
...
- provider_backlog: `238` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `17495` callable operations (`99.2%`), external adapter coverage `99.5%`, verification evidence coverage `10.3%`, evidence-adjusted adapter candidates `0`
...
- verification: `1825` total, `486` verified, `146` failed, `1193` skipped, `0` unknown
