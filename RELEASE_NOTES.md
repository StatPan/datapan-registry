...
- generated_at: `2026-07-03T14:33:40Z`
- provider: `data.go.kr`
...
- provider_adapters: `60` adapters, `67` hosts
- split_readiness: `ready`
- verification_capable_adapters: `60`
- call_capable_adapters: `23`
- dependency_operations: `15293` total, `11419` gateway, `3683` external, `3673` registered-adapter, `29` missing-adapter
...
- provider_backlog: `216` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `15151` callable operations (`99.1%`), external adapter coverage `99.2%`, verification evidence coverage `10.0%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `16` batches, `105` planned operations, `10744` gateway gaps, `2818` adapter gaps
...
- verification: `1530` total, `254` verified, `113` failed, `1163` skipped, `0` unknown
