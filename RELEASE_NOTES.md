...
- generated_at: `2026-07-03T20:57:33Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3465` changed, `8595` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `92` adapters, `109` hosts
- split_readiness: `ready`
- verification_capable_adapters: `92`
- call_capable_adapters: `23`
- dependency_operations: `19459` total, `11419` gateway, `7849` external, `7839` registered-adapter, `29` missing-adapter
...
- provider_backlog: `261` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `19317` callable operations (`99.3%`), external adapter coverage `99.6%`, verification evidence coverage `15.4%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `20` batches, `133` planned operations, `10714` gateway gaps, `3708` adapter gaps
- verification_plan_artifact: `reports/verification-plan.json`
- runtime_evidence_growth: `15.4%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3000` total, `1259` verified, `281` failed, `1460` skipped, `0` unknown
