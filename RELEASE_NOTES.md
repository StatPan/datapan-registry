...
- generated_at: `2026-06-30T07:16:50Z`
- provider: `data.go.kr`
...
- coverage: `12063` callable operations (`98.8%`), external adapter coverage `95.4%`, verification evidence coverage `5.4%`, evidence-adjusted adapter candidates `0`
...
- verification_plan: `1` batches, `10` planned operations, `11349` gateway gaps, `0` adapter gaps
- verification_plan_artifact: `reports/verification-plan.json`
- runtime_evidence_growth: `5.4%` coverage, target `10.0%`, remaining `565`, status `below_target`
...
- verification: `656` total, `22` verified, `87` failed, `547` skipped, `0` unknown
