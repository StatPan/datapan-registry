...
- generated_at: `2026-07-03T19:14:02Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `27` changed, `12033` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `84` adapters, `99` hosts
- split_readiness: `ready`
- verification_capable_adapters: `84`
- call_capable_adapters: `23`
- dependency_operations: `18555` total, `11419` gateway, `6945` external, `6935` registered-adapter, `29` missing-adapter
...
- provider_backlog: `251` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `18413` callable operations (`99.2%`), external adapter coverage `99.6%`, verification evidence coverage `11.0%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `11.0%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `2041` total, `632` verified, `212` failed, `1197` skipped, `0` unknown
