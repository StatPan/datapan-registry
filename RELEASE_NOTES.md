...
- generated_at: `2026-07-03T21:55:35Z`
- provider: `data.go.kr`
...
- specs: `12060`
- catalog_diff: `0` added, `0` removed, `3650` changed, `8410` stable
- catalog_diff_artifact: `reports/catalog-diff.json`

## Provider Coverage

- provider_adapters: `98` adapters, `118` hosts
- split_readiness: `ready`
- verification_capable_adapters: `98`
- call_capable_adapters: `23`
- dependency_operations: `19830` total, `11419` gateway, `8220` external, `8210` registered-adapter, `29` missing-adapter
...
- provider_backlog: `268` hosts, `11` missing-adapter hosts, `29` operations needing adapters
- coverage: `19688` callable operations (`99.3%`), external adapter coverage `99.6%`, verification evidence coverage `16.6%`, evidence-adjusted adapter candidates `0`
...
- runtime_evidence_growth: `16.6%` coverage, target `10.0%`, remaining `0`, status `above_target`
...
- verification: `3291` total, `1519` verified, `306` failed, `1466` skipped, `0` unknown
