...
- Registered external adapters: `airport`, `andong`, `calspia`, `car`, `car365`, `chungnam`, `codil`, `consumer`, `culture`, `daejeon`, `data-gg`,
...
- External adapter coverage: `8241` registered-adapter operations out of `8251`
  external endpoint operations (`99.6%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`101` adapters, `101` verification-capable, `23` call-capable)
- Runtime verification evidence: `3322` bounded checks merged into
  `reports/latest-verification.json` (`1550` verified, `306` failed, `1466`
  skipped)
- Runtime evidence growth target: `15.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19861`
