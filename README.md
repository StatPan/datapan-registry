...
- External adapter coverage: `8806` registered-adapter operations out of `8816`
...
- Runtime verification evidence: `3956` bounded checks merged into
  `reports/latest-verification.json` (`2107` verified, `306` failed, `1543`
  skipped)
- Runtime evidence growth target: `19.4%` checked evidence is above the
  unrounded `10%` release target; `0` additional records are required for this
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `20426`
