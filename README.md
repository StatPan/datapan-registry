...
- Runtime verification evidence: `756` bounded checks merged into
  `reports/latest-verification.json` (`22` verified, `87` failed, `647`
  skipped)
- Runtime evidence growth target: `6.2%` checked evidence against the `10%`
  release target; `465` additional records are still required.
