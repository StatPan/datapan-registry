...
- External adapter coverage: `1903` registered-adapter operations out of `1913`
  external endpoint operations (`98.5%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`42` adapters, `42` verification-capable, `23` call-capable)
- Runtime verification evidence: `1358` bounded checks merged into
  `reports/latest-verification.json` (`114` verified, `112` failed, `1132`
  skipped)
- Runtime evidence growth target: `10.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `13523`
