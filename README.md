...
- Specs: `12060`
- Operations: `15664`
- Callable operations: `15522` (`99.1%`)
- Latest release: `v2026.06.25.24`
- Registered external adapters: `airport`, `andong`, `calspia`, `car365`, `codil`, `culture`, `data-gg`,
  `dgfca`, `dongjak`, `ekape`, `emuseum`, `epost`, `eshare`, `ex`, `folk`, `foodsafetykorea`, `forest`,
  `garak`, `gblib`, `geoje`, `gimhae`, `gwanak`, `gwangmyeong`, `happysd`, `humetro`,
  `i815`, `icheon`, `ins24`, `itfind`, `jeju`, `jeju-air`, `jejudatahub`, `jeonju`, `juso`,
  `kistep`, `korad`, `kpx`, `lh-ebid`, `lofin365`, `mafra`, `myhome`, `naqs`, `ncpms`, `nfqs`,
  `nongsaro`, `oneclick-law`, `open-law`, `pqis`, `q-net`, `safemap`, `safetydata`,
  `seoul-bus`, `seogu`, `seoul-open-data`, `sisul`, `sisul-www`, `tour`, `uiryeong`, `ulsan`, `vworld`,
  `wamis`, `work`, `work24`
- External adapter coverage: `4044` registered-adapter operations out of `4054`
  external endpoint operations (`99.3%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`63` adapters, `63` verification-capable, `23` call-capable)
- Runtime verification evidence: `1567` bounded checks merged into
  `reports/latest-verification.json` (`290` verified, `114` failed, `1163`
  skipped)
- Runtime evidence growth target: `10.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `15664`
