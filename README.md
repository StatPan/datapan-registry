...
- External adapter coverage: `6698` registered-adapter operations out of `6708`
...
- Runtime verification evidence: `1925` bounded checks merged into
  `reports/latest-verification.json` (`581` verified, `147` failed, `1197`
  skipped)
- Runtime evidence growth target: `10.5%` checked evidence is above the
  unrounded `10%` release target; `0` additional records are required for this
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `18318`
