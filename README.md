...
- Registered external adapters: `airport`, `andong`, `culture`, `data-gg`,
  ...
  `wamis`, `work`, `work24`
- External adapter coverage: `3673` registered-adapter operations out of `3683`
...
- Runtime verification evidence: `1530` bounded checks merged into
  `reports/latest-verification.json` (`254` verified, `113` failed, `1163`
  skipped)
- Runtime evidence growth target: `10.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `15293`
