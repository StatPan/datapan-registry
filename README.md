...
- External adapter coverage: `733` registered-adapter operations out of `743`
  external endpoint operations (`96.2%`)
...
- Runtime evidence growth target: `10.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `12353`
