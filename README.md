...
- External adapter coverage: `7772` registered-adapter operations out of `7782`
  external endpoint operations (`99.6%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`91` adapters, `91` verification-capable, `23` call-capable)
- Runtime verification evidence: `2900` bounded checks merged into
  `reports/latest-verification.json` (`1217` verified, `223` failed, `1460`
  skipped)
- Runtime evidence growth target: `15.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19392`
