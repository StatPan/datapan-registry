...
- Registered external adapters: `airport`, `andong`, `calspia`, `car`, `car365`, `chungbuk-tour`, `chungnam`, `codil`, `consumer`, `culture`, `daejeon`, `data-gg`,
  ...
  `i815`, `icheon`, `ins24`, `ip-navi`, `itfind`, `its`, `jeju`, `jeju-air`, `jeju-www`, `jejudatahub`, `jejuits`, `jeonju`, `jeonnam-redtable`, `jongno`, `juso`,
  `kipris-plus`, `khoa`, `kistep`, `kma-apihub`, `kofpi`, `korad`, `kosmes`, `kpx`, `lh-ebid`, `lofin365`, `mafra`, `mafra-legacy`, `mnd-open-data`, `much`, `myhome`, `naa`, `nabic`, `naqs`, `ncpms`, `nfqs`,
  `nongsaro`, `nosc`, `oneclick-law`, `open-assembly`, `open-law`, `opendart`, `pqis`, `psis`, `q-net`, `recycling-info`, `safemap`, `safetydata`,
  `seogu`, `seogwipo`, `seoul-bus`, `seoul-map`, `seoul-open-data`, `seoul-tdata`, `sexoffender`, `sisul`, `sisul-www`, `smartfarm-korea`, `stcis`, `tour`, `uiryeong`, `ulsan`, `vworld`,
  `wamis`, `work`, `work24`, `worldjob`, `cancer`
- External adapter coverage: `8307` registered-adapter operations out of `8317`
  external endpoint operations (`99.7%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`103` adapters, `103` verification-capable, `23` call-capable)
- Runtime verification evidence: `3388` bounded checks merged into
  `reports/latest-verification.json` (`1616` verified, `306` failed, `1466`
  skipped)
- Runtime evidence growth target: `15.0%` checked evidence is above the
  unrounded `10%` release target; `0` additional records are required for this
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19927`
