...
- Registered external adapters: `airport`, `andong`, `anyang`, `calspia`, `car`, `car365`, `childcare-info`, `chungbuk-tour`, `chungnam`, `codil`, `consumer`, `culture`, `daegu`, `daejeon`, `data-gg`,
  ...
  `kipris-plus`, `khoa`, `kistep`, `kisti`, `kma-apihub`, `kofpi`, `korad`, `koreapost`, `kosmes`, `kpx`, `kric`, `lh-ebid`, `lofin365`, `mafra`, `mafra-legacy`, `mnd-open-data`, `mpva-egonghun`, `much`, `myhome`, `naa`, `nabic`, `naqs`, `ncpms`, `nfqs`, `nie-ecobank`,
  `nier-nesc`, `nihc`, `nrich`, `nrf`, `nongsaro`, `nosc`, `oneclick-law`, `open-assembly`, `open-law`, `opendart`, `pqis`, `psis`, `q-net`, `recycling-info`, `safemap`, `safetydata`,
...
- External adapter coverage: `9194` registered-adapter operations out of `9204`
  external endpoint operations (`99.7%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`121` adapters, `121` verification-capable, `23` call-capable)
- Runtime verification evidence: `4331` bounded checks merged into
  `reports/latest-verification.json` (`2456` verified, `332` failed, `1543`
  skipped)
- Runtime evidence growth target: `20.8%` checked evidence is above the
  unrounded `10%` release target; `0` additional records are required for this
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `20814`
