...
- Runtime verification evidence: `636` bounded checks merged into
  `reports/latest-verification.json` (`22` verified, `87` failed, `527`
  skipped)
- Runtime evidence growth target: `5.2%` checked evidence against the `10%`
  release target; `585` additional records are still required.
