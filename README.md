...
- External adapter coverage: `8337` registered-adapter operations out of `8347`
...
- Runtime verification evidence: `3438` bounded checks merged into
  `reports/latest-verification.json` (`1646` verified, `306` failed, `1486`
  skipped)
- Runtime evidence growth target: `15.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19957`
