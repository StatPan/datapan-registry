...
- External adapter coverage: `8059` registered-adapter operations out of `8069`
...
- Runtime verification evidence: `3191` bounded checks merged into
  `reports/latest-verification.json` (`1443` verified, `282` failed, `1466`
  skipped)
- Runtime evidence growth target: `15.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19679`
