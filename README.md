...
- External adapter coverage: `8306` registered-adapter operations out of `8316`
  external endpoint operations (`99.7%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`102` adapters, `102` verification-capable, `23` call-capable)
- Runtime verification evidence: `3387` bounded checks merged into
  `reports/latest-verification.json` (`1615` verified, `306` failed, `1466`
  skipped)
- Runtime evidence growth target: `15.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19926`
