...
- Registered external adapters: `airport`, `andong`, `calspia`, `car`, `car365`, `codil`, `culture`, `data-gg`,
  ...
  `wamis`, `work`, `work24`
- External adapter coverage: `4442` registered-adapter operations out of `4452`
...
- Runtime verification evidence: `1607` bounded checks merged into
  `reports/latest-verification.json` (`329` verified, `115` failed, `1163`
  skipped)
- Runtime evidence growth target: `10.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `16062`
