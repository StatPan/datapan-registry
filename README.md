...
- External adapter coverage: `1100` registered-adapter operations out of `1110`
  external endpoint operations (`97.4%`)
...
- Runtime evidence growth target: `10.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `12720`
