...
- External adapter coverage: `8376` registered-adapter operations out of `8386`
...
- Runtime verification evidence: `3477` bounded checks merged into
  `reports/latest-verification.json` (`1685` verified, `306` failed, `1486`
  skipped)
- Runtime evidence growth target: `17.4%` checked evidence is above the
  unrounded `10%` release target; `0` additional records are required for this
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19996`
