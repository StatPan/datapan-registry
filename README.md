...
- External adapter coverage: `5438` registered-adapter operations out of `5448`
...
- Runtime verification evidence: `1774` bounded checks merged into
  `reports/latest-verification.json` (`436` verified, `145` failed, `1193`
  skipped)
- Runtime evidence growth target: `10.4%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `17058`
