...
- Runtime verification evidence: `646` bounded checks merged into
  `reports/latest-verification.json` (`22` verified, `87` failed, `537`
  skipped)
- Runtime evidence growth target: `5.3%` checked evidence against the `10%`
  release target; `575` additional records are still required.
