...
- External adapter coverage: `9005` registered-adapter operations out of `9015`
  external endpoint operations (`99.7%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`117` adapters, `117` verification-capable, `23` call-capable)
- Runtime verification evidence: `4142` bounded checks merged into
  `reports/latest-verification.json` (`2267` verified, `332` failed, `1543`
  skipped)
- Runtime evidence growth target: `20.1%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `20625`
