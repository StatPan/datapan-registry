...
- Registered external adapters: `airport`, `andong`, `calspia`, `car`, `car365`, `chungnam`, `codil`, `consumer`, `culture`, `daejeon`, `data-gg`,
  ...
  `kipris-plus`, `kistep`, `kma-apihub`, `kofpi`, `korad`, `kosmes`, `kpx`, `lh-ebid`, `lofin365`, `mafra`, `mafra-legacy`, `mnd-open-data`, `much`, `myhome`, `naa`, `nabic`, `naqs`, `ncpms`, `nfqs`,
  `nongsaro`, `oneclick-law`, `open-assembly`, `open-law`, `opendart`, `pqis`, `psis`, `q-net`, `safemap`, `safetydata`,
...
- External adapter coverage: `8210` registered-adapter operations out of `8220`
  external endpoint operations (`99.6%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`98` adapters, `98` verification-capable, `23` call-capable)
- Runtime verification evidence: `3291` bounded checks merged into
  `reports/latest-verification.json` (`1519` verified, `306` failed, `1466`
  skipped)
- Runtime evidence growth target: `15.0%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `19830`
