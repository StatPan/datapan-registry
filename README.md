...
- External adapter coverage: `9275` registered-adapter operations out of `9285`
...
- Runtime verification evidence: `4412` bounded checks merged into
  `reports/latest-verification.json` (`2537` verified, `332` failed, `1543`
  skipped)
- Runtime evidence growth target: `21.1%` checked evidence is above the
  unrounded `10%` release target; `0` additional records are required for this
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `20895`
