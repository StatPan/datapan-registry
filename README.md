...
- External adapter coverage: `9607` registered-adapter operations out of `9617`
  external endpoint operations (`99.7%`)
- Missing external adapter hosts: `11`
- Provider split readiness: `ready`
  (`135` adapters, `135` verification-capable, `23` call-capable)
- Runtime verification evidence: `4744` bounded checks merged into
  `reports/latest-verification.json` (`2824` verified, `377` failed, `1543`
  skipped)
- Runtime evidence growth target: `22.3%` checked evidence is above the
  ...
  target.
- Institution API overview: `411` organizations, `12060` APIs, and `21227`
