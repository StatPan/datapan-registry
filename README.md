...
- Runtime operation evidence: `5362` unique operation identities out of
  `21260` (`25.2%`); fresh successful evidence covers `591` unique operations
  (`2.8%`) as of `2026-09-24T00:03:57.323261Z`.
- Runtime freshness: `1972` evidence records are within the `30` day fresh
  window, `2867` are stale, `183` are expired, and `1360` missing timestamps are
...
- Runtime verification evidence: `6382` bounded checks merged into
  `reports/latest-verification.json` (`3432` verified, `682` failed, `2268`
  skipped)
- Runtime evidence growth target: `30.0%` checked evidence is above the
