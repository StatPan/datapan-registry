...
- `reports/data-go-kr/runtime-evidence-growth.json` measures current runtime
  ...
  batches.
- `reports/data-go-kr/coverage-backlog.json` tracks `4,646` data.go.kr APIs
  without operation mappings, `6,815` operation-mapped APIs without runtime
...
- API operation coverage remains incomplete: `7,414` of `12,060` APIs have
  operation mappings (`61.5%`), leaving `4,646` APIs to materialize and `6,815`
