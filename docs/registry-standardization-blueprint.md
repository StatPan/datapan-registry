...
- Runtime evidence coverage is much lower than callable coverage. Gira #19,
  ...
  Gira #41, Gira #43, Gira #45, Gira #49, and Gira #51 continue gateway
  boundary evidence growth to `686`, but the release readiness warning remains
  active: the `10%` target requires `1,221` evidence records, so `535`
...
14. Expand runtime verification evidence by source/provider priority. Started
    ...
    then by Gira #39, Gira #41, Gira #43, Gira #45, Gira #49, and Gira #51
    with the next gateway batches; this is skipped boundary evidence growth,
