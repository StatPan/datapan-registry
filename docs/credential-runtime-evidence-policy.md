...
#366, #369, #371, #373, #375, #379, #389, #391, #411, #413, #417, #419, and
#421.
...
Credential-gated batch runner pattern:
...
The batch session output and session review plan are local review handoff artifacts, not reviewed receipts. Do not commit `.datapan/runtime-evidence/credential-runtime-collection-session.json` or `.datapan/runtime-evidence/credential-runtime-session-review-plan.json` as release evidence unless a later ticket explicitly adds a checked-in session report path and redaction review boundary.
