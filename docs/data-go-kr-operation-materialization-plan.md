...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 행정안전부 | 1252 | 613 | 639 | 49.0% | 100 | 539 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 행정안전부 | 15147982 | 행정안전부_자동심장충격기AED | 보건의료 | JSON | 자동승인 | 심의승인 | 2025-12-11 |
| 행정안전부 | 15154065 | 행정안전부_녹지_녹피_면적비율 | 농축수산 | JSON | 자동승인 | 심의승인 | 2025-11-25 |
| 행정안전부 | 15154063 | 행정안전부_기간별감염병발생현황 | 보건의료 | JSON | 자동승인 | 심의승인 | 2025-11-25 |
| 행정안전부 | 15154052 | 행정안전부_국외전염병발생현황 | 농축수산 | JSON | 자동승인 | 심의승인 | 2025-11-25 |
| 행정안전부 | 15154049 | 행정안전부_국외검사기관인정현황 | 식품건강 | JSON | 자동승인 | 심의승인 | 2025-11-25 |
...
After materializing operation mappings for a batch, regenerate the coverage backlog, this plan, the institution API overview, and the institution runtime plan. APIs that gain operations should leave this plan and enter runtime reactivation if they still lack verification evidence.
