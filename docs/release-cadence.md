...
- rereads provider-specific verification reports and regenerates bounded
  ...
  gblib, geoje, humetro, itfind, korad, lh-ebid, naqs, oneclick-law, pqis,
  seoul-bus, sisul, tour, uiryeong, ulsan, and the merged latest report;
