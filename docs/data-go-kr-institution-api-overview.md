...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 행정안전부 | 1252 | 1252 | 1767 | 80 | 4.5% | 44 | 25 | 11 | 613 | 0 |
| 경기도 | 840 | 499 | 1351 | 74 | 5.5% | 74 | 0 | 0 | 3 | 0 |
...
- 공공행정: `1645` operations
- 교통물류: `1429` operations
- 농축수산: `1410` operations
- 문화관광: `1396` operations
- 사회복지: `1235` operations
- 산업고용: `1113` operations
- 재정금융: `960` operations
- 환경기상: `897` operations
- 보건의료: `810` operations
- 재난안전: `796` operations
