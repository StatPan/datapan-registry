...
- specs: `12060`
- operations: `20972`
- callable operations: `20830` (`99.3%`)
- data.go.kr gateway operations: `11419`
- external endpoint operations: `9362`
- registered adapter operations: `9352`
- missing adapter operations: `29`
- external adapter coverage: `99.7%`
- approval-required operations: `8048`
- no-endpoint operations: `123`
- service-root operations: `19`
- unsupported-protocol operations: `158`
- registered adapter hosts: `154`
...
한강홍수통제소, `3` 한국농수산식품유통공사, and `22` 국가유산청 국립고궁박물관
link-detail operations. The next viable materialization queue after the current
upstream blockers is `주택도시보증공사`.
